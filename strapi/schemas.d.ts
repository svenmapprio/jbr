...
export interface ApiWorkWork extends CollectionTypeSchema {
  ...
  attributes: {
    name: StringAttribute & RequiredAttribute;
    work_images: RelationAttribute<
      'api::work.work',
      'oneToMany',
      'api::work-image.work-image'
    >;
    type: EnumerationAttribute<['visual', 'sound', 'participation']> &
      RequiredAttribute;
    createdAt: DateTimeAttribute;
    updatedAt: DateTimeAttribute;
...
export interface ApiWorkImageWorkImage extends CollectionTypeSchema {
  info: {
  ...
  attributes: {
    ...
    textPosition: EnumerationAttribute<['top', 'bottom', 'left', 'right']> &
      RequiredAttribute &
      DefaultTo<'bottom'>;
    work: RelationAttribute<
      'api::work-image.work-image',
      'manyToOne',
      'api::work.work'
    >;
